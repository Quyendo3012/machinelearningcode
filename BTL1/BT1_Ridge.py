...
dt_Train, dt_Test = train_test_split(data, test_size=0.3, shuffle = False) #Chia thành hai tập train và test theo tỷ lệ 0.3 và không trộn ngẫu nhiên (không shuffle).
...
mod = Ridge().fit(X_train, y_train) # khoi tao mo hinh Ridge va huan luyen mo hinh tren du lieu x_train va y_train
y_pred = mod.predict(X_test) # dự đoán kết quả dau ra dua tren trên x_test  bang mo hinh da duoc huan luyen
print("hoi quy Ridge")
# print("coefficient of determination: %2f"% r2_score(y_test, y_pred))
print("Ket qua Ridge",y_pred[:3]) #n ra các thông tin về kết quả dự đoán và giá trị thực tế cho 3 mẫu dữ liệu đầu tiên.
