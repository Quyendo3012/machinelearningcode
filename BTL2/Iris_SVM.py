...
pla = svm.SVC(kernel='rbf',tol=0.0001) #kernel : 1 tham số chọn mô hình huấn luyện, tol sai số cho đk dừng
...
acc=accuracy_score(y_pred,y_test)                  #sử dụng hàm accuracy_score để tính tỉ lệ dự đoán bằng cách lấy y_pred / y_test, kq càng gần 1 mô hình càng tốt
print('acc cua svm: ',acc)
